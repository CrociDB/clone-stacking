...
;; Map
(fn map-create [name idx idy player locks]
  (var mx (* idx 30))
  (var my (* idy 17))
...
(var LEVELS [
  (lambda [] (map-create "    Level 1    " 0 1 {:x 8 :y 8 } {}))
  (lambda [] (map-create "    Level 2    " 1 1 {:x 8 :y 8 } {}))
  (lambda [] (map-create "    Level 3    " 2 1 {:x 8 :y 10 } {}))
  (lambda [] (map-create "    Level 4    " 3 1 {:x 2 :y 14 } {}))
  (lambda [] (map-create "    Level 5    " 4 1 {:x 8 :y 8 } [{:x 18 :y 8 :kx 12 :ky 6 :locked true}]))
  (lambda [] (map-create "    Level 5    " 5 1 {:x 8 :y 8 } [{:x 4 :y 8 :kx 20 :ky 8 :locked true}]))
])
...
;; <MAP>
;; 019:
;; 020:
;; 021:
;; 022:
;; 023:
;; 024:
;; 025:
;; 026:
;; 027:
;; 028:
;; 029:
;; 030:
;; 031:
